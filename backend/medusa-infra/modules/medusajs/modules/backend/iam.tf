...
data "aws_iam_policy_document" "ecs_execution_policy" {
  # FIXED: Replaced the conditional dynamic blocks with a static statement
  # to ensure ECR permissions are always present.
  statement {
...
# FIXED: This aws_iam_role was defined twice. One has been removed.
